SimConnect\_CameraDisableFlag

## SimConnect\_CameraDisableFlag

The **SimConnect\_CameraDisableFlag** function can be used to disable camera specific features, but only if the camera has been correctly acquired.
...
| _Flag_ | This is one or more of the `SIMCONNECT_CAMERA_FLAG` enum members, merged using bitwise "or" `|` to create a bitmask which flags specific camera options as disabled. | Bitmask |
