SIMCONNECT\_RECV\_WAYPOINT\_LIST

## SIMCONNECT\_RECV\_WAYPOINT\_LIST

The **SIMCONNECT\_RECV\_WAYPOINT\_LIST** structure is used to return a list of [SIMCONNECT\_DATA\_FACILITY\_WAYPOINT](SIMCONNECT_DATA_FACILITY_WAYPOINT.htm) structures.
...
| Member | Description |
| `rgData[dwArraySize]` | Array of [`SIMCONNECT_DATA_FACILITY_WAYPOINT`](SIMCONNECT_DATA_FACILITY_WAYPOINT.htm) structures. |
