SIMCONNECT\_RECV\_VOR\_LIST

## SIMCONNECT\_RECV\_VOR\_LIST

The **SIMCONNECT\_RECV\_VOR\_LIST** structure is used to return a list of [SIMCONNECT\_DATA\_FACILITY\_VOR](SIMCONNECT_DATA_FACILITY_VOR.htm) structures.
